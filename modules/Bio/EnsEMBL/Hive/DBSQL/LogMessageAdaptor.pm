...
sub store_job_message {
    ...
    if($job_id) {
        ...
        my $sql = qq{
            INSERT INTO $table_name (job_id, attempt_id, role_id, worker_id, retry, status, msg, message_class)
                               SELECT job.job_id, last_attempt_id, job.role_id, worker_id, retry_count, attempt.status, ?, ?
                                 FROM job
